...
class TestUserModel:
    ...
    def test_create_superuser(self):
        ...
        user = User.objects.create_superuser(email="admin@example.com", password="adminpass123", name="Admin User")
...
class TestUserPreferenceModel:
    ...
    def test_create_preference(self):
        ...
        preference = UserPreference.objects.create(email=True, push=False)
